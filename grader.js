...
var restlerUrlFile = function(htmlfile) {
  return rest.get(htmlfile).on('complete', function(data) {
     return data.toString();  // auto convert to object
  });
};
...
var checkFile = function(datafile, checksfile) {
    $ = cheerio.load(datafile);
